...
do_install_de() {
  ...
  local VGA_PKGS=(
    mesa-utils mesa libglvnd vulkan-tools vulkan-radeon vulkan-intel vulkan-nouveau
  )
  if [ $MINIMAL -eq 0 ]; then
    local DE_PKGS=(
      dbus cups xdg-utils noto-fonts noto-fonts-cjk noto-fonts-emoji
      noto-fonts-extra pulseaudio paprefs pavucontrol xfce4 xfce4-terminal thunar-archive-plugin
      thunar-media-tags-plugin xfce4-battery-plugin xfce4-clipman-plugin xfce4-cpufreq-plugin
      xfce4-cpugraph-plugin xfce4-diskperf-plugin xfce4-eyes-plugin xfce4-fsguard-plugin
      xfce4-genmon-plugin xfce4-mailwatch-plugin xfce4-mount-plugin xfce4-mpc-plugin
      xfce4-netload-plugin xfce4-notifyd xfce4-places-plugin xfce4-pulseaudio-plugin
      xfce4-screensaver xfce4-screenshooter xfce4-sensors-plugin xfce4-smartbookmark-plugin
